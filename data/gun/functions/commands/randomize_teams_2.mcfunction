execute as @r[tag=randomize_teams] run function gun:commands/join_blue
...
execute if score team_random team_random matches 0 as @a[tag=randomize_teams] run function gun:commands/join_red