scoreboard objectives modify scoreboard displayname [{"bold":true,"color":"yellow","text":"«Team Deathmatch»"}]

team modify line.1 suffix [{"translate":"space.-112"},"\uE302"]
...
team modify line.10 suffix [{"translate":"space.-76"},{"translate":"space.-76"},{"bold":false,"color":"yellow","text":""}]
