...
execute at @e[type=armor_stand,tag=sonar_1,tag=point_a] run data merge entity @e[type=minecraft:ender_pearl,tag=sonar_3,sort=nearest,limit=1] {Item:{tag:{CustomModelData:1}}}
execute at @e[type=armor_stand,tag=sonar_1,tag=point_b] run data merge entity @e[type=minecraft:ender_pearl,tag=sonar_3,sort=nearest,limit=1] {Item:{tag:{CustomModelData:2}}}
execute at @e[type=armor_stand,tag=sonar_1,tag=point_c] run data merge entity @e[type=minecraft:ender_pearl,tag=sonar_3,sort=nearest,limit=1] {Item:{tag:{CustomModelData:3}}}
