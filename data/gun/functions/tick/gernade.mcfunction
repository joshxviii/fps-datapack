...
execute run scoreboard players operation @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] damage = @s damage
...
execute store result entity @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] Motion[0] double 0.012 run scoreboard players operation @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_x2 -= @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_x
execute store result entity @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] Motion[1] double 0.011 run scoreboard players operation @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_y2 -= @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_y
execute store result entity @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] Motion[2] double 0.012 run scoreboard players operation @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_z2 -= @e[tag=gernade,type=item,sort=nearest,limit=1,nbt={Age:0s}] gernade_dir_z
