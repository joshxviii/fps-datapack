scoreboard objectives remove use_gun
...
scoreboard objectives remove missle_dir_y
scoreboard objectives remove missle_dir_z
...
scoreboard objectives remove model_id
...
scoreboard objectives remove block_time
scoreboard objectives remove crawl_time
scoreboard objectives remove crawl_amount
scoreboard objectives remove stop_crawl
scoreboard objectives remove moving
scoreboard objectives remove p_bullet_angle
scoreboard objectives remove p_rotation
scoreboard objectives remove p_angle_dif
scoreboard objectives remove p_damage
scoreboard objectives remove p_damage_type
scoreboard objectives remove return_hp
scoreboard objectives remove 100

scoreboard objectives remove 180
...
scoreboard objectives remove n1


scoreboard objectives remove 360
...
scoreboard objectives remove vehicle_time
scoreboard objectives remove propeller_time

scoreboard objectives remove plane_sounds
scoreboard objectives remove plane_sounds_2

scoreboard objectives remove atv_time 
scoreboard objectives remove atv_time_old

scoreboard objectives remove fall_dis
scoreboard objectives remove fall_spd
scoreboard objectives remove health
scoreboard objectives remove grd_time

scoreboard objectives remove dash_time
...
scoreboard objectives remove team_random

team remove red_team

scoreboard objectives remove red_kills
team remove blue_team

scoreboard objectives remove blue_kills
...
scoreboard objectives remove looking_at_uuid
scoreboard objectives remove looking_at_old

scoreboard objectives remove fly_pos_x
scoreboard objectives remove fly_pos_y
scoreboard objectives remove fly_pos_z

scoreboard objectives remove fly_mot_y

scoreboard objectives remove fly_rot_x
scoreboard objectives remove fly_rot_y
scoreboard objectives remove target_rot_x2
scoreboard objectives remove target_rot_x
scoreboard objectives remove target_rot_y



scoreboard objectives remove tank_rot_x
scoreboard objectives remove tank_h_rot_x
scoreboard objectives remove tank_h2_rot_x
scoreboard objectives remove tank_rot_y
