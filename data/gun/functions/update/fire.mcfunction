...
execute if entity @a[distance=..3.5] run particle witch ~ ~ ~ 0.01 0.01 0.01 0 1 normal
...
execute if entity @s[tag=has_sniper,distance=16..] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] run scoreboard players add @s damage 2
execute if entity @s[tag=has_sniper,distance=32..] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] run scoreboard players add @s damage 4
execute if entity @s[tag=has_sniper,distance=64..] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] run scoreboard players add @s damage 6
execute if entity @s[tag=has_sniper,distance=128..] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,limit=1,sort=nearest] run scoreboard players add @s damage 8


execute if entity @s[scores={team=0}] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] as @e[dx=0,type=!#gun:cant_shot,tag=!is_blocking] positioned ~.99 ~.99 ~.99 run function gun:tick/hitbox
execute if entity @s[scores={team=0}] positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] run tag @s[tag=!blaster_charged_max] add has_hit
...
execute positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot,nbt=!{Invulnerable:1b}] unless score @s team = @e[dx=0,type=!#gun:cant_shot,tag=!is_blocking,limit=1,sort=nearest,distance=.1..] team run tag @s[tag=!blaster_charged_max] add has_hit

execute positioned ~ ~ ~ if entity @e[dx=0,type=!#gun:cant_shot] positioned ~-.99 ~-.99 ~-.99 if entity @e[dx=0,type=!#gun:cant_shot] as @e[dx=0,type=!#gun:cant_shot] store result score @s health run data get entity @s Health
...
execute if block ~ ~ ~ minecraft:water if block ~ ~.1 ~ #gun:shot_past unless block ~ ~.1 ~ minecraft:water run particle splash ~ ~.3 ~ 0.05 0.33 0.05 0.4 16 normal
execute if block ~ ~ ~ minecraft:water if block ~ ~.1 ~ #gun:shot_past unless block ~ ~.1 ~ minecraft:water run playsound minecraft:entity.generic.splash player @a[distance=..64] ~ ~ ~ 1.5 1.6 0
execute if block ~ ~ ~ minecraft:water if block ~ ~.5 ~ minecraft:water run particle bubble ~ ~.2 ~ 0.01 0.01 0.01 0.01 1 force
...
execute positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] run scoreboard players set @a[gamemode=!spectator,gamemode=!creative,tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] p_damage_type 1
execute if entity @s[scores={team=0}] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] run scoreboard players operation @a[gamemode=!spectator,gamemode=!creative,tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] p_damage += @s damage
execute positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] unless score @s team = @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] team run scoreboard players operation @a[gamemode=!spectator,gamemode=!creative,tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] p_damage += @s damage

execute if entity @s[tag=has_hit] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 positioned ~ ~-1.35 ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] run title @s actionbar ["",{"text":"+5 Headshot","color":"white"},""]
execute if entity @s[tag=has_hit] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 positioned ~ ~-1.35 ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] run scoreboard players add @s points 5
execute if entity @s[tag=has_hit] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 positioned ~ ~-1.35 ~ as @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] at @s run scoreboard players operation @s headshot = @s p_damage
execute if entity @s[tag=has_hit] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 positioned ~ ~-1.35 ~ as @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] at @s run scoreboard players operation @s headshot /= 4 4
execute if entity @s[tag=has_hit] positioned ~ ~ ~ if entity @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] positioned ~-.99 ~-.99 ~-.99 positioned ~ ~-1.35 ~ as @a[tag=!is_blocking,dx=0,limit=1,sort=nearest,distance=.1..] at @s run scoreboard players operation @s p_damage += @s headshot
